...
A free-to-play factory automation game focused on accessibility and strategic resource management.
...
```
2. Install GameMaker Studio
3. Follow setup instructions in the `docs/` folder

## Gameplay Overview

### Resources
- Resource nodes appear on the map for extraction
- Choose between predictable or random resource tile placement
- Infinite resource nodes allow focus on optimization strategies
